...
```json
{"ts":[{"t":"Topic Name","ty":"use_case","f":"High","c":95,"ev":{"sourceIds":["src_001"],"confidenceReason":"Supported by product and demand evidence.","warnings":[]}},{"t":"Another Topic","ty":"purchase_decision","f":"Medium","c":82}]}
```
